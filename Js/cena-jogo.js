...
export default class CenaJogo extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('fala1', 'Imagens/fala1.2.png');
    ...
    create(){
        ...
        let persAleatorio = this.selecionaPersonagem();
        this.persAtual = new Personagem(this, 100, 330, persAleatorio.sprite, persAleatorio.fala, persAleatorio.spriteOver);
        ...
        // mouse over no npc
        npc.on('pointerover', () => {
            npc.setTexture(persAleatorio.spriteOver);
            spriteFala.setTexture(persAleatorio.fala);
        });
        npc.on('pointerout', () => {
            npc.setTexture(persAleatorio.sprite);
